      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          <div className="flex-1 text-center lg:text-left content-spacing">
            ...
            <h1 className="text-5xl lg:text-7xl font-sans font-black text-foreground mb-8 leading-tight animate-fade-in-left stagger-2">
              Bringing Medical{" "}
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground mb-10 max-w-2xl leading-relaxed animate-fade-in-left stagger-3">
            ...
            <div className="animate-fade-in-left stagger-4">
              <Button
                size="lg"
                className="bg-accent hover:bg-accent/90 text-accent-foreground font-semibold px-8 py-4 text-lg hover-lift hover-glow transform-3d animate-bounce"
              >
                Explore Our Work
          ...
          <div className="flex-1 relative animate-fade-in-right stagger-2">
            <div className="relative w-full max-w-lg mx-auto perspective-1000">
              ...
              <div className="glass-card rounded-3xl p-10 shadow-2xl hover-lift transform-3d animate-bounce">
                <div className="relative overflow-hidden rounded-xl">
                  ...
                  />
                  <div className="absolute top-6 right-6 glass-card bg-accent/95 text-accent-foreground px-4 py-2 rounded-full text-sm font-semibold animate-pulse hover-lift">
                    Interactive 3D
                  </div>
                  <div className="absolute bottom-6 left-6 glass-card bg-primary/95 text-primary-foreground px-4 py-2 rounded-full text-sm font-semibold animate-pulse hover-lift stagger-2">
                    Educational
                  </div>
